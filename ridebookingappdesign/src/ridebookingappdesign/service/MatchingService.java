...
import ridebookingappdesign.domain.strategy.DriverMatchingStrategy;
...
public class MatchingService {
    ...
    public Optional<Driver> matchDriver(Ride ride) {
        ...
        List<Driver> suggestions = matchingStrategy.findMatchingDrivers(ride.getPickupLocation(), availableDrivers,
                DEFAULT_MAX_RESULTS);
        ...
        for (Driver driver : suggestions) {
            ...
            try {
                ...
                while (System.currentTimeMillis() - startTime < DRIVER_RESPONSE_TIMEOUT_MS
                        || ride.getStatus() == RideStatus.DENIED) {
