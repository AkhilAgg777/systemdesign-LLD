package ridebookingappdesign.domain.state;
...
public class RideStateMachine {
    ...
    public RideStateMachine() {
        ...
        allowedTransitions.put(RideStatus.ASSIGNED,
    ...
    // TODO: Replace this simple validation with full state objects per STEP-4 once
    // interview time allows.
}